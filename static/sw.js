// TXL Cloud service worker - minimal, just enough for installability.
...
const CACHE_NAME = "txl-cloud-shell-v1";
const SHELL_ASSETS = ["/static/icons/icon-192.png", "/static/icons/icon-512.png"];
